...
/**
 * Ticket verification suite for CCF-101 — ticking "I want to join a DGroup" during
 * registration produced nothing an admin could see. The intent was used only to
 * reveal the matching questions and was then dropped on submit.
 *
 * Run locally:  pnpm verify:ticket CCF-101
 */
