...
export async function POST(request: Request) {
  ...
  if (!clientId || resource !== expectedResource) return NextResponse.json({ error: "invalid_request", error_description: "client_id and the Churchie MCP resource are required" }, { status: 400 })
