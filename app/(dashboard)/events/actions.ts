  ...
  try {
    const event = await db.event.create({
      data: {
        ...
        registrationStart: parsed.data.type === "MultiDay" ? null : (parsed.data.registrationStart ?? null),
        registrationEnd: parsed.data.type === "MultiDay" ? null : (parsed.data.registrationEnd ?? null),
