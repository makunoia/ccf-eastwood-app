...
export function CommitteeManager({ ministryId, committees }: Props) {
  ...
  async function handleAddCommittee() {
    ...
    const result = await createMinistryCommittee(ministryId, { name: committeeName })
  ...
  async function handleDeleteCommittee() {
    ...
    const result = await deleteCommittee(deleteCommitteeId, { ministryId })
  ...
  async function handleAddRole() {
    ...
    setSavingRole(true)
    const result = await createRole(addRoleCommitteeId, { name: roleName }, { ministryId })
    setSavingRole(false)
    if (result.success) {
  ...
  async function handleDeleteRole() {
    ...
    const result = await deleteRole(deleteRoleId, { ministryId })
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <p className="text-sm text-muted-foreground">
          Committees and roles for volunteer registration in this ministry.
        </p>
        <Button
          type="button"
          size="sm"
              ...
              <div className="flex items-center justify-between px-4 py-3">
                ...
                <div className="flex items-center gap-2">
                  <Button
                    ...
                    size="sm"
                    onClick={() => {
                      setAddRoleCommitteeId(committee.id)
                    }}
                  >
                    <IconPlus className="size-4" />
                    Add role
        ...
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={savingCommittee || !committeeName.trim()}
            >
      ...
      >
        <DialogContent>
          ...
          <p className="text-sm text-muted-foreground">
            ...
            ? All roles in this committee will also be deleted. This action
            cannot be undone.
          </p>
          <DialogFooter>
            <Button
              variant="outline"
              onClick={() => setDeleteCommitteeId(null)}
